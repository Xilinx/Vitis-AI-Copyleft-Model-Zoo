...
from yolov6_nndct.models.loss_distill import *
from yolov6_nndct.solver.build import *
from yolov6_nndct.utils.checkpoint import *
from yolov6_nndct.utils.RepOptimizer import *
...
def main(args):
    ...
    if args.quant:
        ...
        is_nndct_qat = False
    with RewriterContext(cfg=dict(conv_act_builder=conv_act_builder, is_nndct_qat=is_nndct_qat), backend=Backend.NNDCT.value, ir=IR.XMODEL):
        # Start
