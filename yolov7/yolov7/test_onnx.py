...
from utils.torch_utils import select_device, time_synchronized, ONNXModel
...
def test(data,
    ...
    model = ONNXModel(model, onnx_file, device, imgsz, runtime=onnx_runtime, data_type=precision)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--onnx-file', type=str, default='yolov7.onnx', help='model.pt path(s)')
    ...
    parser.add_argument('--onnx-runtime', default='onnx', help='onnx runtime')
